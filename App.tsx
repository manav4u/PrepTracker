  ...
  useEffect(() => {
    try {
        ...
        if (saved) {
          ...
          // Schema Validation: Ensure critical fields exist to prevent crashes
          if (parsed && typeof parsed === 'object' && Array.isArray(parsed.selectedSubjects)) {
             setProfile(parsed);
          } else {
             console.error("Profile data corrupted or invalid schema. Resetting.");
          }
        }
    } catch (e) {
  ...
  return (
    <ErrorBoundary>
        ...
        ">
            ...
            <Routes>
                <Route path="/" element={<Dashboard selectedIds={profile.selectedSubjects || []} />} />
