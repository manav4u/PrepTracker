            ...
            <div className="bg-[#050505] rounded-[2.2rem] p-8 relative overflow-hidden">
                ...
                <div className="space-y-4">
                    ...
                    >
                        ...
                        {loading ? (
                            ...
                            <>
                                ...
                                <span className="relative z-20">Sign In with Google</span>
                            </>
                        )}
                    </button>
                    ...
                    <div className="flex items-center gap-4 opacity-30">
                        ...
                        <span className="text-[9px] uppercase tracking-widest font-mono text-white">OR</span>
                        <div className="h-px bg-white flex-1"></div>
                    </div>
                    ...
                    <button
                        onClick={handleGoogleLogin}
                        disabled={loading}
                        className="w-full py-4 border border-white/10 hover:border-white/30 bg-transparent text-white font-bold uppercase tracking-[0.1em] rounded-2xl transition-all duration-300 flex items-center justify-center gap-4 hover:bg-white/5"
                    >
                         {loading ? (
                    ...
                    <p className="text-center text-[10px] text-slate-500 font-medium leading-relaxed px-4 pt-2">
                        Existing users can sign in with their registered Google account. New users will be guided through setup.
                    </p>
                </div>
